...
<br/>
  ...
  <v-card-title >
    ...
    <v-card-text>
      <div> Los 4 que han sumado más puntos a lo largo de las 7 snapshots se clasificarán a las finales nacionales.</div>
    </v-card-text>
 </v-card>
  ...
  <v-card-title >
    ...
    <v-card-text>
      <div> Los 2 primeros de cada copa clasifican a las finales nacionales, y los 4 primeros clasifican a la GSC(Golden Spatula Cup,
